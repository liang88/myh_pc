        ...
        <div class="screen_show">
          ...
          <div class="searchalls">
             <div class="search_div">
               <input type="text" placeholder="输入楼盘名或者区域" v-model="search_house" class="search_text2"/>
               <p class="search_font" >共有{{mynum}}个楼盘</p>
               <input type="button" @click="searchs" value="搜索" class="search_btn2"/>
             </div>
            <div class="search_history">搜索历史:<a href="#">{{showsousuo}}</a> </div>
          </div>
          <!---------分类----------->
          <div class="screen_select">
            ...
            <div class="area">
              ...
              <div class="citys">
                ...
                <a href="#" :class="thisx==3?'hovercty':''" @click="averagesload(3)" >1万至2万</a>x
                <a href="#" :class="thisx==4?'hovercty':''" @click="averagesload(4)" >2万以上</a>
              </div>
              <div class="citys_price">单价(元/平)
                <input type="text" onkeyup="value=value.replace(/[^/d]/g,'') "  v-model="frommuch"/>
                -
                <input type="text" onkeyup="value=value.replace(/[^/d]/g,'') "   v-model="tomuch"/>
            ...
            <div class="area">
              ...
              <div class="citys">
                ...
                <a href="#" :class="layouts=='二室'?'hovercty':''"  @click="layoutload('二室')" >二室</a>
...
export default {
  ...
  methods: {
    loadrun () {
      // console.log(this.twodata[nhs].name)
      //
    ...
    searchs () {
      //  this.types = 2
      this.historycn = this.search_house
      var searchinfos = {
      ...
      setCookie('showsousuo', this.search_house)
      getCookie('showsousuo')
